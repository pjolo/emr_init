...
* section[1].text.div = "<div xmlns='http://www.w3.org/1999/xhtml'><p>Notfallkontakt: Elisabeth Meier (Ehefrau) +41 31 456 78 90</li></ul></div>"
* section[1].entry = Reference(UC2-RelatedPerson-ElisabethMeier)

// Care Team Section
* section[2].title = "Care Team"
...
* section[3].title = "Resuscitation status"
...
// Medication Section
* section[4].title = "Current medication"
...
* section[7].title = "Problems and diagnoses"
...
* section[8].title = "Medical Devices"
